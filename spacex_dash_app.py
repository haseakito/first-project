...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_launch = selected_df.groupby(['Launch Site', 'class']).size().reset_index(name='class count')
        fig = px.pie(filtered_launch, values = 'class count')
        names = 'Class'
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        selected_df = slide_df[slide_df['Launch Site'] == entered_site]
